					    ...
					    if(url.indexOf(compare.toLowerCase())!=-1 && url.indexOf("shoppingbaba.in")==-1) {
					     ...
					     // message = merchant_data[1] + "," + merchant_data[2];  //shopping baba store + "," + discount
					      panel = '<div id="shoppingbaba_main" style="' + main_css +
									'"><header style="'+ header_css + '"><img src="http://shoppingbaba.in/assets/images/newimages/logo.png" id="logo" width="250px" '
									 + 'style="width:250px; position:absolute; top:15px;"></header><div id="content" style="' + content_css
